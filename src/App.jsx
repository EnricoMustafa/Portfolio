  ...
  <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-40 w-full max-w-6xl">
    ...
    <div className="w-full lg:max-w-xl text-center lg:text-left">
      <h1 className="h-20 flex items-center justify-center lg:justify-start">
        <span className="font-serif text-3xl sm:text-4xl md:text-5xl whitespace-nowrap">
          {text}
        </span>
      </h1>
      
      <p className="mt-4 font-serif text-lg sm:text-xl md:text-2xl text-justify">
...
<section className="min-h-screen w-full px-4 py-8">
  <h1 className="text-black pt-4 font-serif text-3xl sm:text-4xl md:text-5xl text-center">
    Meus projetos
  </h1>

  <div className="flex flex-col lg:flex-row items-center justify-center gap-10 mt-8 w-full">
    {/* Projeto 1 */}
    <div className="p-6 rounded-xl shadow-xl w-full max-w-md border border-gray-400 flex flex-col items-center h-auto">
      ...
      <div className="flex justify-around mt-3 w-full">
        <a
          ...
          className="bg-black text-white p-2 w-24 rounded-lg hover:animate-pulse hover:bg-gray-400 font-semibold text-center"
        >
          Acessar
        </a>
        <a
    ...
    {/* Projeto 2 - Em Breve */}
    <div className="p-6 rounded-xl shadow-xl w-full max-w-md border border-gray-400 flex flex-col items-center h-auto">
      <h1 className="text-center font-semibold text-xl sm:text-2xl">Em breve</h1>
      <div className="w-full h-48 sm:h-52 bg-black rounded-t-xl mt-2 border border-gray-400 flex items-center justify-center">
        <VscLoading
          color="white"
          size={50}
      ...
      <div className="bg-black rounded-b-xl w-full">
        <h1 className="text-white text-center font-semibold p-2">Em Processo</h1>
      </div>
      <div className="flex justify-around mt-3 w-full">
        <button
          onClick={semTela}
          className="bg-black text-white p-2 w-24 rounded-lg hover:animate-pulse hover:bg-gray-400 font-semibold"
        >
          Acessar
        </button>
        <button
...
<section className="w-full px-4 py-12">
  <div className="p-4 rounded-xl shadow-xl border border-gray-400 w-full max-w-2xl mx-auto h-auto">
    <h1 className="text-black font-serif text-3xl sm:text-4xl md:text-5xl text-center">
      Contato
    </h1>
    <form
    ...
    >
      <input
        className="border rounded-xl w-full sm:w-4/5 p-2"
        type="text"
      ...
      <input
        type="submit"
        value="Enviar"
        className="bg-black rounded-lg cursor-pointer mt-2 hover:bg-white hover:text-black border text-white w-1/2 sm:w-1/3 p-3 font-semibold"
      />
      {successMessage && (
